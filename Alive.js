...
xTroid.addCMD({pattern: 'alive', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
xTroid.addCMD({pattern: 'alive', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
